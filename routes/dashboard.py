...
def init_db():
    ...
    # جدول سرورهای خارج (اصلاح شده برای ذخیره پورت و یوزر)
...
# --- Server Management (توابعی که ارور داده بودند) ---

def add_server(ip, user, password, port):
    """ذخیره اطلاعات سرور خارج در دیتابیس"""
    conn = sqlite3.connect(DB_PATH)
    c = conn.cursor()
    # چون فعلا فقط یک سرور ساپورت می‌کنیم، قبلی‌ها را پاک می‌کنیم
...
# اجرای اولیه برای ساخت جداول (اگر فایل اجرا شود)
